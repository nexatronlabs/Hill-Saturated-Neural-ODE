...
if __name__ == "__main__":
    ...
    # 1. Benchmark Vanilla Neural ODE
    vanilla_func = VanillaNeuralODEFunc(state_dim=2, hidden_dim=64)
    history_vanilla, _ = train_and_benchmark(vanilla_func, "Standard Vanilla Neural ODE", epochs=EPOCHS)
    
    # 2. Benchmark Proposed Surgical Hill-Kinetics Saturation
    saturated_func = SaturatedNeuralODEFunc(state_dim=2, hidden_dim=64, phi_init=0.33)
